...
struct OTDBQuestion: Codable {
    
    // MARK: Initializers
    
    /// Creates a question with the given arguments.
    ///
    /// The `string`, `correctAnswer`, and `incorrectAnswers` arguments will be
    /// HTML-decoded, if possible.
    ///
    ...
    init(from decoder: Decoder) throws {
        ...
        let difficulty = try values.decode(Difficulty.self, forKey: .difficulty)
